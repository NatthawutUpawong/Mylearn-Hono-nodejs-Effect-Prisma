...
export class UserServiceContext extends Context.Tag("service/User")() {
    static Live = Layer.effect(this, Effect.all({
        ...
        return {
            ...
            updateByAdmin: (id, data) => repo.updateByAdmin(id, data).pipe(Effect.withSpan("update.user-by-admin.service")),
            updateByUser: (id, data) => repo.updateByUser(id, data).pipe(Effect.withSpan("update.user-by-user.service")),
        };
    })));
}

...
import type { Branded, OrganizationSchema, ORGWithRelarionSchema } from "../../schema/index.js"
...
export type OrganizationRepository = {
  ...
  findManyPagination: (limit: number, offset: number,) => Effect.Effect<OrganizationSchema.OrganizationArray, Errors.findManyORGError>
